...
/**
 * An implementation of {@link NamedProperty} interface.
 */
public class NamedPropertyImpl implements NamedProperty {
	 ...
	 */
	public NamedPropertyImpl(String name, JsonType type, JsonType[] moreTypes, boolean required) {
		if (name == null) {
