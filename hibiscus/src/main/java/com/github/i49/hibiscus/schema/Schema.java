 ...
 * This object is the top level component for any schema being built.
 * 
...
public interface Schema {
	...
	/**
	 * Specifies JSON types allowed to be at the root of JSON documents.
	...
	/**
	 * Returns the set of JSON types allowed to be at the root of JSON documents.
	 * @return the set of JSON types allowed to be at the root of JSON documents.
	 */
	TypeSet getTypeSet();
}
